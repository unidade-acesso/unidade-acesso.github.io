...
<p lang="en">Everything that is said below about the eXaminator's score applies to AccessMonitor. The original text is in Spanish.</p>
...
<p>Si la técnica se relaciona con más de un Criterio de Conformidad, su valor aumenta 0.1 y disminuye 0.1 cuando es sólo una técnica sugerida y se relaciona con un único Criterio de Conformidad. (De todas las decisiones que se deben tomar al definir el sistema de medición, esta escala es, claramente, la más arbitraria.)</p>
